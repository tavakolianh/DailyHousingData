...
C=grpstats(A,{'x25','x2', 'x16'},'mean','DataVars','x8');
% C(:,'GroupCount') = [];
...
C.Properties.VarNames{5} = 'Mean';
D=grpstats(C,{'Date', 'Age'},{'mean','sum'},'DataVars',{'Mean','NumTrans'});
D(:,{'GroupCount','mean_NumTrans','sum_Mean'}) = [];
% D(:,'GroupCount') = [];
D.Properties.ObsNames=[];
D.Properties.VarNames{2} = 'Age';
D.Properties.VarNames{3} = 'Mean';
D.Properties.VarNames{4} = 'NumTrans';
